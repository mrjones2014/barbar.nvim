...
" set ignored filetypes to hide winbar in specified filetypes
let bufferline.disabled_filetypes = {}
" set ignored buftypes to hide winbar in specified buftypes
let bufferline.disabled_buftypes = {}
```
